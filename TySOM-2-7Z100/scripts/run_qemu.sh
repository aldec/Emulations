...
-initrd ./$project_name/images/linux/rootfs.cpio.gz.u-boot \
-gdb tcp::9000 \
-dtb ./$project_name/images/linux/system.dtb \
-net nic,netdev=eth0 \
...
-hw-dtb ./$project_name/qemu_cosim/qemu_hw_system.dtb \
-machine-path ./$project_name/qemu_cosim \
-icount 1 \
