...
sed -i s':onerror {quit -force}:set GENERIC_PATH /design_1_wrapper/design_1_i/processing_system7_0/QEMU_PATH_TO_SOCKET_G \
echo $GENERIC_PATH \
set QUANTUM_GENERIC_PATH /design_1_wrapper/design_1_i/processing_system7_0/QEMU_SYNC_QUANTUM_G \
...
python3 ./scripts/generate_sim_files.py  hardware/reference_project/reference_project.gen/sources_1/bd/design_1/ip/design_1_processing_system7_0_0/design_1_processing_system7_0_0_stub.vhdl riviera/
