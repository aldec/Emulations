...
{
    unsigned long long int GP_AXI_CTRL = 0x3000000000;
    unsigned long long int GP_AXI_A = 0x1000000000;
    unsigned long long int GP_AXI_B = 0x2000000000;

    // device file locations
    char *fifo_out_dev = "/dev/axis_fifo_0x00000000a0000000";
