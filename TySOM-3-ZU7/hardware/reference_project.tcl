...
#
# Generated by Vivado on Wed Jun 22 14:30:54 CEST 2022
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../src/constr/constr.xdc"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part" -value "aldec.com:tysom_3_zu7:part0:1.1" -objects $obj
...
set_property -name "platform.board_id" -value "tysom_3_zu" -objects $obj
...
set_property -name "webtalk.riviera_launch_sim" -value "20" -objects $obj
...
set file "[file normalize ${origin_dir}/../src/constr/constr.xdc]"
...
# Axi2AxiStream, Axi2AxiStream, Axi2AxiStream, core
  ...
  set PL_user_switches [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 PL_user_switches ]
  ...
  if { [catch {set Axi2AxiStream_a [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.AXI4_DATA_WIDTH {128} \
   CONFIG.AXI4_ID_WIDTH {16} \
 ] $Axi2AxiStream_a
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {PL_user_switches} \
...
SPI Flash#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO0 MIO#GPIO0\
MIO#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#NAND#GPIO1\
MIO#NAND#GPIO1 MIO#GPIO1 MIO#I2C 0#I2C 0#UART 1#UART\
1#DPAUX#DPAUX#DPAUX#DPAUX#SD 0#PCIE#SD 0#SD 0#SD 0#SD 0#SD 0#SD 1#SD 1#SD 1#SD\
1#SD 1#SD 1#SD 1#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem\
2#Gem 2#Gem 2#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem\
3#Gem 3#MDIO 2#MDIO 2} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;97FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;1|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports PL_user_switches] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axis_clock_converter_o/s_axis_aresetn] [get_bd_pins proc_sys_reset_200/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins core_0/pi_rst] [get_bd_pins proc_sys_reset_200/peripheral_reset]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Axi2AxiStream_a/clk] [get_bd_pins Axi2AxiStream_b/clk] [get_bd_pins Axi2AxiStream_c/clk] [get_bd_pins axi_fifo_mm_s_o/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_clock_converter_o/m_axis_aclk] [get_bd_pins axis_data_fifo_a/s_axis_aclk] [get_bd_pins axis_data_fifo_b/s_axis_aclk] [get_bd_pins axis_data_fifo_c/s_axis_aclk] [get_bd_pins axis_dwidth_converter_o/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_100/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_100/ext_reset_in] [get_bd_pins proc_sys_reset_200/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Axi2AxiStream_a/rstn] [get_bd_pins Axi2AxiStream_b/rstn] [get_bd_pins Axi2AxiStream_c/rstn] [get_bd_pins axi_fifo_mm_s_o/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_clock_converter_o/m_axis_aresetn] [get_bd_pins axis_data_fifo_a/s_axis_aresetn] [get_bd_pins axis_data_fifo_b/s_axis_aresetn] [get_bd_pins axis_data_fifo_c/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_o/aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_100/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]

  # Create address segments
  assign_bd_address -offset 0x001000000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Axi2AxiStream_a/S00_AXI/reg0] -force
  assign_bd_address -offset 0x002000000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Axi2AxiStream_b/S00_AXI/reg0] -force
  assign_bd_address -offset 0x003000000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Axi2AxiStream_c/S00_AXI/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_o/S_AXI/Mem0] -force
